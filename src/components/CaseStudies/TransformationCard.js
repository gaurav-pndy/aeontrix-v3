...
export default function TransformationCard({ study }) {
  return (
    <Link href={`/case-studies/${study.slug}`} className="block h-full">
      <div className="flex flex-col h-full rounded-lg border border-border bg-surface shadow-sm overflow-hidden transition hover:shadow-md cursor-pointer">
        {/* HEADER */}
        ...
        <div className="flex flex-col flex-1 p-4 md:p-6 md:pt-4">
          ...
          <div className="mt-auto flex items-center justify-between">
            <span className="text-primary small-text font-medium whitespace-nowrap hover:underline">
